	...
	<head>
		...
		<script>
            function validateForm() {
                const radios = document.getElementsByName("select_flight");
                let formValid = false;
                ...
                if (!formValid) alert("Please select a flight.");
                return formValid;
            }
        </script>
			...
			if(isset($_POST['Search']))
			{
				...
				if(empty($data_missing))
				{
					...
					if($class=="economy")
					{
						...
						{
							echo "<form action=\"book_tickets2.php\" method=\"post\" onsubmit=\"return validateForm();\">";
