...
$con=mysqli_connect("localhost","root","123456","airline_reservation");
...
<!--<center><img src='images/logo.jpg' class='img-thumbnail' width='1200px' style='height:80px;'></center>-->
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <center><font style="font-family:Arial Black; font-size:20px;">
                   ...
                   $row1 = mysqli_fetch_array($result1)  ; 
                        ...
                        echo "<center><img src='images/logo.jpg' class='img-thumbnail' width='180px' style='height:180px;'></center>";
                   ?>
                        </td>
                 </tr>   
